...
EXEC msdb.dbo.sp_send_dbmail 'ALERT_SQL', 'fchantada@agea.com.ar', @body = @string, @subject = @string
...
EXEC msdb.dbo.sp_send_dbmail @profile_name = 'ALERT_SQL', @recipients = 'fchantada@agea.com.ar', @body = @string, @subject = @string
END
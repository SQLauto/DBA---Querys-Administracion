...
/****** Object:  StoredProcedure [dbo].[SmartDefragmentation_SP]    Script Date: 16/05/2016 11:46:42 a.m. ******/
SET ANSI_NULLS ON
GO
...
BEGIN CATCH
	...
	EXEC master.dbo.InsertJobHistory_SP @JobName='DBA - SmartDefragmentation INMUEBLES', @Output = @ErrorMessage
	EXEC master.dbo.InsertJobHistory_SP @JobName='DBA - SmartDefragmentation INMUEBLES', @Output = 'FIN PROCESO'

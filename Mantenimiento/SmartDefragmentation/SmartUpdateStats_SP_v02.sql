USE [EMPLEOS]
GO
/****** Object:  StoredProcedure [dbo].[SmartUpdateStats_SP]    Script Date: 17/05/2016 01:55:35 p.m. ******/
SET ANSI_NULLS ON
GO
...
BEGIN TRY
SET NOCOUNT ON
-- EXEC [EMPLEOS].dbo.SmartUpdateStats_SP 48,20,30

EXEC master.dbo.InsertJobHistory_SP @JobName='DBA - SmartUpdateStats EMPLEOS', @Output = 'INICIO PROCESO'
	...
	BEGIN
		...
		IF @TotalRows > 15000000
				BEGIN
					...
					EXEC master.dbo.InsertJobHistory_SP @JobName='DBA - SmartUpdateStats EMPLEOS', @Output = @Output
					--PRINT @cmd
...
EXEC master.dbo.InsertJobHistory_SP @JobName='DBA - SmartUpdateStats EMPLEOS', @Output = 'FIN PROCESO'

SET NOCOUNT OFF
END TRY
BEGIN CATCH
	SELECT @ErrorMessage = ERROR_MESSAGE(), @ErrorSeverity = ERROR_SEVERITY(), @ErrorState = ERROR_STATE(); 
	EXEC master.dbo.InsertJobHistory_SP @JobName='DBA - SmartUpdateStats EMPLEOS', @Output = @ErrorMessage
	EXEC master.dbo.InsertJobHistory_SP @JobName='DBA - SmartUpdateStats EMPLEOS', @Output = 'FIN PROCESO'

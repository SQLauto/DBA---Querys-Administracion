USE [DEAUTOS_P]
GO
/****** Object:  StoredProcedure [dbo].[SmartDefragmentation_SP]    Script Date: 17/05/2016 02:17:06 p.m. ******/
SET ANSI_NULLS ON
GO
...
SET @JobName = 'DBA - SmartDefragmentation DEAUTOS_P'
...
BEGIN
	...
	BEGIN
		...
		BEGIN
			...
			BEGIN
				SET @cmd = 'UPDATE STATISTICS ['+@SchemaName+'].['+@TableName+'] ['+@IndexName +'] WITH SAMPLE 20 PERCENT'
	...
	BEGIN
		...
		--IF @alloc_unit_type_desc <> 'LOB_DATA' -- Si no posee un tipo de Dato LOB lo fuerzo a lo que haga ONLINE.
